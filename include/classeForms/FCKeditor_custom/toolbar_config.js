...
FCKConfig.ToolbarSets['classeForms'] = [
	['Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','OrderedList','UnorderedList','Outdent','Indent','-','TextColor','BGColor','Table','Rule'],
	['FontFormatSimple','FontNameSimple','FontSizeSimple','Undo','Redo','-','Link','Unlink','Anchor','My_Find','My_Replace']
] ;
...
FCKConfig.SkinPath = FCKConfig.BasePath + 'skins/red/' ;
...
FCKConfig.ToolbarSets['classeForms'] = [
	['Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','OrderedList','UnorderedList','Outdent','Indent','-','TextColor','BGColor','Table','Rule'],
	['FontFormatSimple','FontNameSimple','FontSizeSimple','Undo','Redo','-','Link','Unlink','Anchor','Smiley','Image','Flash','SpecialChar','-','My_Find','My_Replace']
] ;
