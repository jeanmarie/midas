...
<blockquote>
  ...
  <?php 
	...
	$def_SORTSELECT   = ( isset($_POST['SORTSELECT']) )    ? $_POST['SORTSELECT']         : "";	
	$def_LE_FOND   =    ( isset($_POST['LE_FOND']) )       ? $_POST['LE_FOND']            : "3399CC";	
    ...
    $f->frm_ObjetBoutonsRadio("BTN_RAD", array("label" => "Activer",
											  ...
											  "activation" => array(
																	...
																	"MOYEN",
																	array("LISTE_LONGUE","UPLOAD","SORTSELECT","LE_FOND"),
	...
	$f->frm_OngletDefinir( array("width" => "500px", "height" => "200px") );
    ...
    $f->frm_SautLignes(1);			
    $f->frm_ObjetListe("MOYEN",         array("label" => "Mode déplacement", "rows" => "5", "attrib" => "", 'default' => $def_moyen,
	...
	if ( !empty($radio_activation) ) {
//	(integer) $radio_activation
		$f->frm_OngletDefaut( $radio_activation - 1  ); 
	}
