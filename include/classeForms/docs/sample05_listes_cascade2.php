...
<blockquote>
  ...
  <p><span class="titre1 style1"><a href="index.php#ANNEXES"><br>
    <img src="new4-167.gif" width="16" height="16" border="0"></a> <a href="sample05_listes_cascade.php"><img src="fleche_.gif" width="16" height="16" border="0"></a><a href="sample05_listes_cascade3.php"><img src="fleche.gif" width="16" height="16" border="0"></a> <span class="style3">CHAMPS &quot;LISTES EN CASCADE&quot; MODE DEBUG POUR MISE AU POINT DES XML  </span></span>
    <?php		
	...
	$def_LISTES_CASCADES_V = ( isset($_POST['LISTES_CASCADES_V']) )  ? stripslashes($_POST['LISTES_CASCADES_V'])       : "";	
	$def_LISTES_CASCADES_V2 = ( isset($_POST['LISTES_CASCADES_V2']) )  ? stripslashes($_POST['LISTES_CASCADES_V2'])       : "17007";	
	...
	$f->frm_SautLignes(1);
    $f->frm_ObjetListesCascade("LISTES_CASCADES_RO",       array(
												"label" => "listes en lecture seule",
												"orientation" => "V",
											    "attrib" => "+",
												"default" => $def_LISTES_CASCADES_V2,
												"help" => "choisir une option et une sous-option",   
	                                            "width" => "200px",
												"list" => array( 
															array( 'id'     => 'REGION',
