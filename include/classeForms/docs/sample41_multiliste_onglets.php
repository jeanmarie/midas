...
<blockquote>
  ...
  <p><span class="titre1 style1"><strong><a href="index.php#ANNEXES"><br>
    <img src="new4-167.gif" width="16" height="16" border="0"></a> <a href="sample40_multiliste_blocs.php"><img src="fleche_.gif" width="16" height="16" border="0"></a><a href="sample42_multiliste_script.php"><img src="fleche.gif" width="16" height="16" border="0"></a> </strong>LISTE A CHOIX DE VALEURS DANS UNE PLAGE </span>
    <?php		
	...
	$f->frm_OngletDefinir( array("width" => "450px", "height" => "250px") );


	$f->frm_OngletNouveau('Normal');
    ...
    $f->frm_ObjetMultiListe("LISTE_T1",       array(
												...
												"rows" => "10",
												"modeblock" => true,
												"script" => "alert('script défini !');",
												"help" => "Selectionner des lignes de la liste",
												"width" => "120px"),
								  	          $tableau1
											  );
	$f->frm_OngletNouveau('Save'); 
	...
	$f->frm_OngletNouveau('Append'); 

	$f->frm_SautLignes(1);
    $f->frm_ObjetMultiListe("LISTE_T3",       array(
											    "label" => "Mode 'append'<br>bloc continu avec effacement en cas d'erreur",
												"default" => $def3,
												"rows" => "10",
												"modeblock" => true,
	...
	$f->frm_OngletNouveau('Activation'); 
