...
<blockquote>
  <p><span class="titre1 style1"><a href="index.php#ANNEXES"><br>
    <img src="new4-167.gif" width="16" height="16" border="0"></a> <a href="sample50_message_ok.php"><img src="fleche_.gif" width="16" height="16" border="0"></a><a href="sample51_message_simple_target.php"><img src="fleche.gif" width="16" height="16" border="0"></a> <span class="style3">MESSAGE SIMPLE APRES VALIDATION</span></span>
  <br>    
    <?php		
