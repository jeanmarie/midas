...
<blockquote>
  ...
  <p><span class="titre1 style1"><a href="index.php#ANNEXES"><br>
    <img src="new4-167.gif" width="16" height="16" border="0"></a> <a href="sample05_listes_cascade2.php"><img src="fleche_.gif" width="16" height="16" border="0"></a><a href="sample05_listes_cascade4.php"><img src="fleche.gif" width="16" height="16" border="0"></a> <span class="style3">CHAMPS &quot;LISTES EN CASCADE&quot; AVEC ACTIVATION </span></span>
    <?php		
    ...
    $f->frm_ObjetBoutonsRadio("BTN_RAD", array("label" => "Activer",
											  ...
											  "activation" => array(array("LISTES_CASCADES_H","NOM"),"LISTES_CASCADES_V") ),
