...
<blockquote>
  <p><span class="titre1 style1"><a href="index.php#ANNEXES"><br>
    <img src="new4-167.gif" width="16" height="16" border="0"></a> <a href="sample02_protection.php"><img src="fleche_.gif" width="16" height="16" border="0"></a><a href="sample50_message_ok.php"><img src="fleche.gif" width="16" height="16" border="0"></a> <span class="style3">UTILISATION D'UNE TEMPORISATION
    <DIV id=COOL_REDIRECT_COUNTER>X</DIV>SECONDES Cliquer sur un champ la neutralise</span></span> 
    <?php		
	...
	$f->frm_InitTimeOut(10,'index.php#TIMEOUT_EXEMPLE','COOL_REDIRECT_COUNTER');
