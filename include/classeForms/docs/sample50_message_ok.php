<?php
	...
	$f->frm_InitTimeOut(30,$url_cible,'COOL_REDIRECT_COUNTER');
...
<blockquote>
  <p><span class="titre1 style1"><a href="index.php#ANNEXES"><br>
    <img src="new4-167.gif" width="16" height="16" border="0"></a> <a href="sample49_timeout.php"><img src="fleche_.gif" width="16" height="16" border="0"></a><a href="sample51_message_simple.php"><img src="fleche.gif" width="16" height="16" border="0"></a> <span class="style3">MESSAGE APRES COCHE SUR 'CONFORT' + VALIDATION</span></span>
<DIV id=COOL_REDIRECT_COUNTER></DIV><br>    
    <?php		
