<?php
	...
	switch ( $ret ) {
		...
		case "A1" :
			$f->frm_Message( array( 	'text' => "La fiche modifiée a été correctement enregistrée, en cliquant sur l'icone ci-contre ou ouvre l'url dans une autre fenêtre, a utiliser par exemple pour une impression PDF à suivre",
										'url'  => $url_cible,
